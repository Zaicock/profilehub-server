...
function initializeDefaultData() {
    ...
    if (!users.find(u => u.username === 'admin')) {
        const adminUser = {
            ...
            avatar_url: 'https://www.facebook.com/photo/?fbid=122144397266177809&set=pcb.122144398094177809&__cft__[0]=AZba6xTxoRTboiBbELNZSBxHyc9raJVm-3Jkin2VLOQXcEkYVFrM0k-gOeR4hzUOyNBRf7DkGvBZobLIe9hs0eyowGIIiCcKp_v16WBQ1p5bz94AX25j7qL2iGJt-s0GcmuaR_z7Tdapc79v3JkEImuFwzMhLM5juNNsni6-MuGDuQ&__tn__=*b1H-R',
    ...
    if (frames.length === 0) {
        frames = [
            ...
            },
            {
                ...
                image_url: 'https://placehold.co/150/FFD700/000000?text=Gold+Frame',
                price_points: 500,
                category: 'premium',
                available: true,
                created_by: 1,
            ...
            },
            {
                ...
                image_url: 'https://placehold.co/150/B9F2FF/000000?text=Diamond+Frame',
                price_points: 2000,
                category: 'premium',
                available: true,
                created_by: 1,
            ...
            },
            {
                ...
                css_class: 'frame-vip',
                image_url: 'https://placehold.co/150/9B30FF/000000?text=VIP+Frame',
                price_points: 5000,
                category: 'vip',
                available: true,
                created_by: 1,
            ...
            },
            {
                ...
                image_url: 'https://placehold.co/150/007AFF/000000?text=Developer+Frame',
                price_points: 0,
                category: 'developer',
                available: false,
                created_by: 1,
...
// ===== Active Users Route (MUST BE BEFORE :id) =====
app.get('/api/users/active', authMiddleware, (req, res) => {
    try {
        // Return mostly recent active users or just random subset for "Home" feed
        // Sort by last_seen
        const activeUsers = users
            ...
            .map(u => ({
                ...
                bio: u.bio,
                is_online: Boolean(connectedUsersMap.has(u.id)),
                frame_id: u.frame_id
            }));
